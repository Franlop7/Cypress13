...
describe("User Sign-up and Login", function () {
  ...
  it("Debería redireccionar al usuario no autenticado a la página de inicio de sesión", function () {
    cy.visit("/personal");
    cy.location("pathname").should("equal", "/signin");
    // cy.visualSnapshot("Redirect to SignIn");
  });

  it.only("Debería redireccionar a la página de inicio después del inicio de sesión", function () {
  ...
  it("Debería recordar a un usuario durante 30 días después del inicio de sesión", function () {
    // cy.database("find", "users").then((user: User) => {
    //   cy.login(user.username, "s3cret", { rememberUser: true });
    // });
  ...
  it("Debería permitir que un visitante se registre, inicie sesión y cierre sesión", function () {
    // const userInfo = {
    //   firstName: "Bob",
    //   lastName: "Ross",
  ...
  it("Debería mostrar errores de inicio de sesión", function () {
    // cy.visit("/");
  ...
  it("Debería mostrar errores de registro", function () {
  ...
  it("Debería mostrar error para un usuario inválido", function () {
  ...
  it("Debería mostrar error para una contraseña inválida de un usuario existente", function () {
    // cy.database("find", "users").then((user: User) => {
